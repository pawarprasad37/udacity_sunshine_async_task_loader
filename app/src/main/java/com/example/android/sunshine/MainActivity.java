...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private void loadWeatherData() {
        ...
        Loader<String> loader = loaderManager.getLoader(WEATHER_LOADER_ID);
        if (loader == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, args, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID, args, this);
        }

    }

    public static final int WEATHER_LOADER_ID = 100;
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                URL weatherRequestUrl = NetworkUtils.buildUrl(args.getString(KEY_LOCATION));
                try {
                    return NetworkUtils
    ...
    @Override
    public void onLoadFinished(Loader<String> loader, String jsonWeatherResponse) {
        try {
